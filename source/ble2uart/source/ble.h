...
u8        conn_state_get(void);         // 0=idle 1=connecting 2=connected
u16       conn_handle_get(void);
void      conn_peer_addr_get(u8 *out);  // 6 bytes, little-endian
u8        conn_peer_addr_type_get(void);
u16       conn_interval_get(void);      // units: 1.25ms
