...
# Installation script for Telink BLE SDK V4.0.2.2 from GitHub.
...
#
# NOTE: liblt_8258.a in V4.0.2.2 (and V4.0.2.3) has a bug that causes the BLE
# stack to crash/freeze when receiving Coded PHY advertisements. Use
# install_sdk_v4021.sh instead if Coded PHY scanning is required.
