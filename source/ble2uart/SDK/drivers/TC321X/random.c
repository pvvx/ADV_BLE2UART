...
/**
 * @brief     This function performs to initial random number generator.
 * @param[in] none.
 * @note      This interface used to drop the first byte, the first byte usually 0 or one specific value.
 *            This interface is already called by cpu_wakeup_init during system initialization,
 *            so there is no need to call it again in user code. Of course, if you are not sure,
 *            you can also call it again or check the randomness of the first generated byte.
 */
