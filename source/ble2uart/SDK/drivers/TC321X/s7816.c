...
void s7816_set_trx_pin(uart_num_e uart_num,GPIO_PinTypeDef Pin_7816_TRX)
{
    ...
    if(uart_num == UART0){
        if(Pin_7816_TRX == GPIO_PB0){
            gpio_set_func(Pin_7816_TRX,15);
        }else if(Pin_7816_TRX == GPIO_PD7){
            gpio_set_func(Pin_7816_TRX,UART_RTX_IO);
        }else if(Pin_7816_TRX == GPIO_PE0 || Pin_7816_TRX == GPIO_PE1){
            gpio_set_func(Pin_7816_TRX,UART_PE_RTX_IO);
        }
    }else if(uart_num == UART1){
        if(Pin_7816_TRX == GPIO_PB0){
            gpio_set_func(Pin_7816_TRX,UART1_RTX_IO);
        }
    }else if(uart_num == UART2){
        if(Pin_7816_TRX == GPIO_PB0){
            gpio_set_func(Pin_7816_TRX,UART2_RTX_IO);
        }else if(Pin_7816_TRX == GPIO_PB3){
            gpio_set_func(Pin_7816_TRX,UART2_PB3_RTX_IO);
        }
    }
