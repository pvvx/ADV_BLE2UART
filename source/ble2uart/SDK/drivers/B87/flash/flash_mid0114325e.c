 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
unsigned char flash_write_status_mid0114325e(unsigned short data, unsigned int mask)
{
	if (0 != (data & ~mask))
	{
		return 2;
	...
	unsigned short status = flash_read_status_mid0114325e();
	if(data != (status & mask))	//To reduce the operation of the status register.
	{
		...
		status = flash_read_status_mid0114325e();
	}
	if(data == (status & mask))
	{
		return 1;
...
{
	return flash_write_status_mid0114325e(data, FLASH_WRITE_STATUS_BP_MID0114325E);
}
...
{
	return flash_write_status_mid0114325e(FLASH_LOCK_NONE_MID0114325E, FLASH_WRITE_STATUS_BP_MID0114325E);
}
...
{
	return flash_read_status_mid0114325e()&FLASH_WRITE_STATUS_BP_MID0114325E;
}
