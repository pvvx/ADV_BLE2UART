...
unsigned char flash_write_status_mid0113325e(unsigned short data, unsigned int mask)
{
	...
	unsigned short status = flash_read_status_mid0113325e();
	if(data != (status & mask))	//To reduce the operation of the status register.
	{
		...
		status = flash_read_status_mid0113325e();
	}
	if(data == (status & mask))
	{
		return 1;
...
{
	return flash_write_status_mid0113325e(data, FLASH_WRITE_STATUS_BP_MID0113325E);
}
...
{
	return flash_write_status_mid0113325e(FLASH_LOCK_NONE_MID0113325E, FLASH_WRITE_STATUS_BP_MID0113325E);
}
...
{
	return flash_read_status_mid0113325e()&FLASH_WRITE_STATUS_BP_MID0113325E;
}