...
#define APP_MAX_LENGTH_ADV_DATA														31
...
#define APP_MAX_LENGTH_PER_ADV_DATA													100
...
void app_periodic_adv_test(void)
{
	...
	for(int i=0;i<APP_MAX_LENGTH_ADV_DATA;i++){
		testAdvData[i] = i;
	}

	blc_ll_setExtAdvData( ADV_HANDLE0,    APP_MAX_LENGTH_ADV_DATA, (u8 *)testAdvData);
	...
	blc_ll_setPeriodicAdvData( ADV_HANDLE0, APP_MAX_LENGTH_ADV_DATA, testAdvData);
