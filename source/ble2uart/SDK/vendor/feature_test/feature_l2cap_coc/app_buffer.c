...
_attribute_ble_data_retention_	u8 mtu_m_rx_fifo[ACL_CENTRAL_MAX_NUM * MASTER_MTU_BUFF_SIZE_MAX];

_attribute_ble_data_retention_	u8 mtu_s_rx_fifo[ACL_PERIPHR_MAX_NUM * SLAVE_MTU_BUFF_SIZE_MAX];
_attribute_ble_data_retention_	u8 mtu_s_tx_fifo[ACL_PERIPHR_MAX_NUM * SLAVE_MTU_BUFF_SIZE_MAX];
...
_attribute_ble_data_retention_	u8	app_test_data[MASTER_ACL_PERIPHR_MAX_NUM][TEST_DATA_LEN];
