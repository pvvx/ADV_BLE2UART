...
const u8	tbl_advData[] = {
	 4,  DT_COMPLETE_LOCAL_NAME, 				'p','h','y',
...
// phy feature test
/////////////////////////////////////////////////////////////////////
u32 test_tick[MASTER_ACL_PERIPHR_MAX_NUM];
u32 phy_update_agree_ftick[MASTER_ACL_PERIPHR_MAX_NUM];

#define SPP_DATA_LEN   8
u8 spp_data[8][SPP_DATA_LEN];

_attribute_ble_data_retention_  u8  phy_init_enable[MASTER_ACL_PERIPHR_MAX_NUM];
