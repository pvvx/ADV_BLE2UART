...
#define NON_RESOLVING_EN            1


int	central_smp_pending = 0; 		// SMP: security & encryption;

u8 whiteList_permit_mac[6] = {0x33,0x88,0x99,0x99,0x99,0x99};
...
#if (NON_RESOLVING_EN)
	blc_ll_addDeviceToWhiteList(BLE_ADDR_PUBLIC, whiteList_permit_mac);
#else ////need to enable SMP
